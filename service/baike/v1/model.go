...
type ListClassificationIterator struct {
	...
	ctx           context.Context
	req           *ListClassificationReq
	listFunc      func(ctx context.Context, req *ListClassificationReq, options ...core.RequestOptionFunc) (*ListClassificationResp, error)
...
type ListEntityIterator struct {
	...
	ctx           context.Context
	req           *ListEntityReq
	listFunc      func(ctx context.Context, req *ListEntityReq, options ...core.RequestOptionFunc) (*ListEntityResp, error)
	options       []core.RequestOptionFunc
	curlNum       int
}
...
type SearchEntityIterator struct {
	...
	ctx           context.Context
	req           *SearchEntityReq
	listFunc      func(ctx context.Context, req *SearchEntityReq, options ...core.RequestOptionFunc) (*SearchEntityResp, error)
	options       []core.RequestOptionFunc
	curlNum       int
}
