...
type UserGroupCreatedEventHandler struct {
	handler func(context.Context, *UserGroupCreatedEvent) error
}

func NewUserGroupCreatedEventHandler(handler func(context.Context, *UserGroupCreatedEvent) error) *UserGroupCreatedEventHandler{
   h := &UserGroupCreatedEventHandler{handler: handler}
   return h
}
/**
返回事件的消息体的实例，用于反序列化用
**/
func (h *UserGroupCreatedEventHandler) Event() interface{} {
...
/**
 回调开发者注册的handle
 r**/
func (h *UserGroupCreatedEventHandler) Handle(ctx context.Context, event interface{}) error {
	return h.handler(ctx, event.(*UserGroupCreatedEvent))
}
...
type UserGroupDeletedEventHandler struct {
	handler func(context.Context, *UserGroupDeletedEvent) error
}

func NewUserGroupDeletedEventHandler(handler func(context.Context, *UserGroupDeletedEvent) error) *UserGroupDeletedEventHandler{
   h := &UserGroupDeletedEventHandler{handler: handler}
   return h
}
/**
返回事件的消息体的实例，用于反序列化用
**/
func (h *UserGroupDeletedEventHandler) Event() interface{} {
...
/**
 回调开发者注册的handle
 r**/
func (h *UserGroupDeletedEventHandler) Handle(ctx context.Context, event interface{}) error {
	return h.handler(ctx, event.(*UserGroupDeletedEvent))
}
...
type UserGroupMemberChangedEventHandler struct {
	handler func(context.Context, *UserGroupMemberChangedEvent) error
}

func NewUserGroupMemberChangedEventHandler(handler func(context.Context, *UserGroupMemberChangedEvent) error) *UserGroupMemberChangedEventHandler{
   h := &UserGroupMemberChangedEventHandler{handler: handler}
   return h
}
/**
返回事件的消息体的实例，用于反序列化用
**/
func (h *UserGroupMemberChangedEventHandler) Event() interface{} {
...
/**
 回调开发者注册的handle
 r**/
func (h *UserGroupMemberChangedEventHandler) Handle(ctx context.Context, event interface{}) error {
	return h.handler(ctx, event.(*UserGroupMemberChangedEvent))
}
...
type UserGroupUpdatedEventHandler struct {
	handler func(context.Context, *UserGroupUpdatedEvent) error
}

func NewUserGroupUpdatedEventHandler(handler func(context.Context, *UserGroupUpdatedEvent) error) *UserGroupUpdatedEventHandler{
   h := &UserGroupUpdatedEventHandler{handler: handler}
   return h
}
/**
返回事件的消息体的实例，用于反序列化用
**/
func (h *UserGroupUpdatedEventHandler) Event() interface{} {
...
/**
 回调开发者注册的handle
 r**/
func (h *UserGroupUpdatedEventHandler) Handle(ctx context.Context, event interface{}) error {
	return h.handler(ctx, event.(*UserGroupUpdatedEvent))
}