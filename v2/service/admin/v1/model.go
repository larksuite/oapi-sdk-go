...
type AdminDeptStatListReq struct {
...
type AdminDeptStatListRespData struct {
	HasMore   *bool            `json:"has_more,omitempty"`
	PageToken *string          `json:"page_token,omitempty"`
	Items     []*AdminDeptStat `json:"items,omitempty"`
}

type AdminDeptStatListResp struct {
	*lark.RawResponse `json:"-"`
	lark.CodeError
	Data *AdminDeptStatListRespData `json:"data"`
}

type AdminUserStatListReq struct {
...
type AdminUserStatListRespData struct {
	HasMore   *bool            `json:"has_more,omitempty"`
	PageToken *string          `json:"page_token,omitempty"`
	Items     []*AdminUserStat `json:"items,omitempty"`
}

type AdminUserStatListResp struct {
	*lark.RawResponse `json:"-"`
	lark.CodeError
	Data *AdminUserStatListRespData `json:"data"`
}
